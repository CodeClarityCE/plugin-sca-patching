...
require (
	github.com/CodeClarityCE/plugin-sbom-javascript v0.0.16-alpha
	github.com/CodeClarityCE/plugin-sca-vuln-finder v0.0.12-alpha
	github.com/CodeClarityCE/utility-amqp-helper v0.0.4-alpha
...
require (
	github.com/CodeClarityCE/service-knowledge v0.0.14-alpha // indirect
