...
require (
	github.com/CodeClarityCE/plugin-sbom-javascript v0.0.5-alpha
	...
	github.com/CodeClarityCE/utility-node-semver v0.0.1-alpha
...
require (
	github.com/CodeClarityCE/service-knowledge v0.0.4-alpha // indirect
