...
require (
	github.com/CodeClarityCE/plugin-sbom-javascript v0.0.7-alpha
	github.com/CodeClarityCE/plugin-sca-vuln-finder v0.0.6-alpha
	github.com/CodeClarityCE/utility-amqp-helper v0.0.2-alpha
	github.com/CodeClarityCE/utility-dbhelper v0.0.3-alpha
	github.com/CodeClarityCE/utility-node-semver v0.0.2-alpha
...
require (
	github.com/CodeClarityCE/service-knowledge v0.0.7-alpha // indirect
