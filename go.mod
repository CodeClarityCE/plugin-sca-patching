...
require (
	...
	github.com/CodeClarityCE/plugin-sca-vuln-finder v0.0.25-alpha
...
require (
	github.com/CodeClarityCE/service-knowledge v0.0.25-alpha // indirect
	github.com/CodeClarityCE/utility-amqp-helper v0.0.12-alpha // indirect
